 ...
 * ============================
 * 
 * This module defines the encoding for keys stored in the MemTable and SSTables.
 * 
 ...
 */
static inline void UnpackSequenceAndType(uint64_t packed, SequenceNumber* seq, ValueType* type) {
    *seq = packed >> 8;
