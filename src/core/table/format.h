 ...
 * These structures allow efficient random access without scanning the entire file.
 *
 * Key Insight:
 ...
 */
lithos_status_code BlockHandle_Decode(Lithos_BlockHandle* h, const char** src, const char* limit);
