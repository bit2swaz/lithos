 ...
 * - IEEE (0x04C11DB7) was designed for Ethernet (detecting bit flips in transmission).
 * - Castagnoli has superior error detection for burst errors common in storage media
 *   (e.g., disk sector corruption, flash page failures).
 * - SSE4.2 and ARM8 CPUs provide hardware acceleration for CRC32C via intrinsics.
 * 
