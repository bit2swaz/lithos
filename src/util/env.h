 ...
 * ===========================================================
 * Databases need to read/write files reliably across different operating
 * systems. The Env abstraction hides OS differences and ensures durability
 * guarantees. Without proper fsync(), crashes can lose committed data.
 *
 ...
 * - File types: Sequential writes (WAL), sequential reads (recovery), random
 * reads (SSTables).
 */
