...
static void Test_EditSerialization(void) {
    ...
    VersionEdit_AddFile(&edit, 0, 10, 123, Slice_FromCString("a"), Slice_FromCString("z"));
...
static void Test_VersionSetApply(void) {
    ...
    VersionEdit_AddFile(&edit1, 0, 10, 100, Slice_FromCString("a"), Slice_FromCString("b"));
    ...
    VersionEdit_AddFile(&edit2, 0, 12, 120, Slice_FromCString("c"), Slice_FromCString("d"));
...
static void Test_VersionRefCounting(void) {
    ...
    VersionEdit e1;
    VersionEdit_Init(&e1);
    VersionEdit_AddFile(&e1, 0, 1, 10, Slice_FromCString("a"), Slice_FromCString("b"));
    ...
    VersionEdit e2;
    VersionEdit_Init(&e2);
    VersionEdit_AddFile(&e2, 0, 2, 20, Slice_FromCString("c"), Slice_FromCString("d"));
