...
static void Test_Cache_Basic(void) {
    ...
    *val1 = 100;
    ...
    Lithos_CacheHandle* h1 = Cache_Insert(cache, MakeSlice("key1"), val1, 10, TestDeleter);
    ASSERT_TRUE(h1 != NULL);
...
static void Test_Cache_LRUEviction(void) {
    ...
    for (int i = 0; i < 10; i++) {
        ...
        *val = i;
        Lithos_CacheHandle* h = Cache_Insert(cache, MakeSlice(key), val, 10, TestDeleter);
...
static void Test_Cache_RefCounting(void) {
    ...
    *valA = 1;
    Lithos_CacheHandle* hA = Cache_Insert(cache, MakeSlice("A"), valA, 100, TestDeleter);
    ...
    *valB = 2;
    Lithos_CacheHandle* hB = Cache_Insert(cache, MakeSlice("B"), valB, 150, TestDeleter);
...
static void Test_Cache_Erase(void) {
    ...
    int* val = malloc(sizeof(int));
    *val = 100;
    Lithos_CacheHandle* h = Cache_Insert(cache, MakeSlice("key1"), val, 10, TestDeleter);
    Cache_Release(cache, h);
...
static void Test_Cache_TotalCharge(void) {
    ...
    int* val1 = malloc(sizeof(int));
    *val1 = 1;
    Lithos_CacheHandle* h1 = Cache_Insert(cache, MakeSlice("key1"), val1, 100, TestDeleter);
    Cache_Release(cache, h1);
    ...
    *val2 = 2;
    Lithos_CacheHandle* h2 = Cache_Insert(cache, MakeSlice("key2"), val2, 50, TestDeleter);
    Cache_Release(cache, h2);
