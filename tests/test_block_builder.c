...
static void Test_BlockBuilder_RestartPoints(void) {
    ...
    BlockBuilder_Add(builder, Slice_FromCString("c"), Slice_FromCString("val_c")); // Restart
    BlockBuilder_Add(builder, Slice_FromCString("d"), Slice_FromCString("val_d"));
    BlockBuilder_Add(builder, Slice_FromCString("e"), Slice_FromCString("val_e")); // Restart
...
static void Test_BlockBuilder_LargeKeys(void) {
    ...
    BlockBuilder_Add(builder, Slice_FromCString(key1), Slice_FromCString("value1"));
    BlockBuilder_Add(builder, Slice_FromCString(key2), Slice_FromCString("value2"));
    BlockBuilder_Add(builder, Slice_FromCString(key3), Slice_FromCString("value3"));
    
    Lithos_Slice block = BlockBuilder_Finish(builder);
    
    // Raw key+value bytes (no compression, no overhead)
    size_t raw_size = strlen(key1) + strlen(key2) + strlen(key3) + 18; // 3 * "value" = 18
